...
def build_retriever(document_id:Optional[str] = None):
    ...
    This is the "Hybrid" retrieval behavior: gloabal by default, scoped on request.
    """
...
def build_conversational_chain(document_id:Optional[str] = None):
    ...
    # same grouding rules as Simple RAG prompt: context-only answers,
    ...
    # rewrite question -> retriever -> answer.
    ...
    # for whatever session_id is passed in at all call time - we never touch
    # history manually
